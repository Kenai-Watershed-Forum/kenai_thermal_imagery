...
The map contains layers with the following data:

-   Project Watershed Boundaries

-   National Hydrography Database

-   Anadromous Waters Catalog[o']

    -   Streams

    -   Lakes

-   Kenai Borough Parcel Boundaries

-   Significant Thermal Features (identified from thermal imagery data by NV5 consultants)
